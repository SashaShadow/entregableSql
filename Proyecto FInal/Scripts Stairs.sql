...
(4, 3, 1, 'Lady E.', 100),
(5, 4, 1, 'Sky', 100),
(2, 2, 1, 'Lord Huron', 100),
(3, 3, 1, 'ACDC.', 100),
(4, 3, 1, 'Metal Icca.', 100),
(10, 2, 1, 'AW.E', 100),
(10, 3, 1, 'HARE.', 100),
(4, 3, 1, 'Mewtal.', 100),
(5, 4, 1, 'Sopor', 100);
...
(1, 'Espada larga', 'Cada 5 ataques puede hacer sangrar al enemigo, lo que le quita 1 hp por turno'),
(2, 'Baston de roble', 'Permite esquivar un ataque en un 20%'),
(3, 'Arco incendiario', 'Lanza flechas con llamas, efectivas contra los orcos y monstruos'),
(4, 'Cuchillo', 'Aumenta el porcentaje de robo con exito'),
(2, 'Arpa antigua', 'Cura un 10% de la hp propia'),
...
(null, 'Pocion curativa', 'Cura 15 de hp');
...
-- Insertamos algunos registros al azar en tiendas_objetos ejecutando esta consulta algunas veces:
...
-- Era un poco lento insertar batallas una por una.
...
-- ...y otra funcion que permite que ganen monstruos o personajes random al insertar los registros
DELIMITER //
...
-- Limitamos los registros de la tabla cantidad_batallas solo a uno con un trigger nuevo (BEF0RE INSERT)
DELIMITER STRS
